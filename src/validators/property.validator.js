...
const propertyDataValidator = () => {
    return [
        ...
        body("type")
            ...
            .withMessage(`Property type must be one of: ${AvailablePropertyTypes.join(", ")}`),
...
const issuesDataValidator = () => {
    return [
        body("type")
            ...
            .withMessage(`Issue type must be one of: ${AvailableIssueTypes.join(", ")}`),
        ...
        body("priority")
            ...
            .withMessage(`Issue priority must be one of: ${AvailableIssuePriority.join(", ")}`),
    ];
};
